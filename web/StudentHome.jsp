<%-- 
    ...
    Created on : Apr 3, 2019, 12:01:07 PM
    Author     : Lim Ji-Siang
--%>
               ...
               <div class="header-right">
                   ...
                   <div>
                       <table class="tableDesign">
                           <tr><th>Menu</th></tr>
                           <tr>
                               <td><a href="BreakFastMeal.jsp">Add Order</a></td>
                           </tr>
                           <tr>
                               <td> <a href="ModifyOrdersMade.jsp">Modify order</a></td>
                           </tr>
                           <tr>
                               <td><a href="cancelOrder.jsp">Cancel Order</a></td>
                           </tr>
                           <tr>
                               <td><a href="printCoupon.jsp">Print Coupon</a></td>
                           </tr>
                           <tr>
                               <td><a href="totalExpensesandCalories.jsp">Total expenses and total calories intake</a></td>
                           </tr>
                       </table>
                   </div>
    </body>
