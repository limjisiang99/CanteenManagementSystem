<%-- 
    ...
    Created on : Apr 10, 2019, 9:05:57 AM
    Author     : Lim Ji-Siang
--%>
    ...
    <body>
        ...
        <div class="header">
               ...
               request.setAttribute("productImage", encode);
                ...
                <a href="cancelOrderServlet?method=get&couponID=<%=arrayB.get(y).getCouponId()%>&mealPrice=<%=arrayC.get(s).getMealPrice()%>&mealQuantity=<%=arrayB.get(y).getQuantity()%>">Cancel</a> 
                </td>
                         <%
                          if((count+1) % 4==0){
                    out.println("<tr>");
