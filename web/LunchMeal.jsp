<%-- 
    Document   : LunchMeal
    Created on : Apr 4, 2019, 8:45:20 PM
    Author     : Lim Ji-Siang
--%>
    ...
    <body>
         <%  String name=(String)session.getAttribute("username"); %>
          <div class="header">
               ...
               <nav>
            <ul>
                <li><a  href="BreakFastMeal.jsp">Breakfast</a></li>
                <li><a class="active" href="LunchMeal.jsp">Lunch</a></li>
            </ul>
        </nav>
        ...
        <% MealDA mealDA = new MealDA();
            ...
            for(int i=0; i<arrayL.size();i++){
               if(arrayL.get(i).getMealSession().equals("Lunch")){
